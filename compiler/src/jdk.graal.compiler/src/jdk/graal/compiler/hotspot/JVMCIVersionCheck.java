...
public final class JVMCIVersionCheck {
    ...
    private static final Map<String, Map<String, Version>> JVMCI_MIN_VERSIONS = Map.of(
                    "25", Map.of(
                                    "Oracle Corporation", createLabsJDKVersion("25.0.4.1.1+1", 1),
                                    DEFAULT_VENDOR_ENTRY, createOpenJDKVersion("25.0.4.1+1")));
     ...
     * <li>{@code java.vm.version}: Full Java VM version string, e.g, {@code "25.0.2+5"}</li>
